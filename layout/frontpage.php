...
<div id="page" class="container-fluid">
    <section class="slideshow">
        ...
        if ($toggleslideshow == 1) {
            require_once(theme_essential_get_include_file('slideshow'));
    ...
    <section role="main-content">
        ...
        if ($togglemarketing == 1) {
            require_once(theme_essential_get_include_file('marketingspots'));
        ...
        if ($frontpagemiddleblocks == 1) {
            require_once(theme_essential_get_include_file('middleblocks'));
